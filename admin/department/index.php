...
class DepartmentPage extends BasePage
{
	...
	{
		//call vw_getAllDepartments
		$stmt = $this->getConnection()->prepare("SELECT * FROM vw_getAllDepartments");
		$stmt->execute();
...
$departments = $page->getAllDepartments();
?>
